...
FILE20=test/ar-thing-at-point-utils-setup-tests.el
...
if [ $WERKSTATT -eq 0 ]; then
    ...
    [ $HOME/werkstatt/thingatpt-utils-core/test/ar-thing-at-point-utils-setup-tests.el -nt ${PWD}/test/ar-thing-at-point-utils-setup-tests.el ] && echo "cp -u $HOME/werkstatt/thingatpt-utils-core/test/ar-thing-at-point-utils-setup-tests.el $PWD/test/"; cp -u $HOME/werkstatt/thingatpt-utils-core/test/ar-thing-at-point-utils-setup-tests.el $PWD/test/
	...
	case $option in
	    ...
	    y) echo "Lade testumgebung \"HIER\"";hier;;
