;;; ar-thing-atpt-other-test4.el --- tests succeeding when called interactively  -*- lexical-binding: t; -*-
...
(provide 'ar-thing-atpt-other-test4)
;;; ar-thing-atpt-other-test4.el ends here
